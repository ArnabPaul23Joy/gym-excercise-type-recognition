...
//
// In an iOS app, add ExerciseClassifier.mlpackage to the target and use
//   ExerciseClassifier(modelURL: ExerciseClassifier.urlOfModelInThisBundle)  // Xcode-generated
// or Bundle.main.url(forResource: "ExerciseClassifier", withExtension: "mlmodelc").
